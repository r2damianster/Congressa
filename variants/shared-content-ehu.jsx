...
const _SCI = [
  ...
  { n: "Janaina Minelli De Oliveira", a: "Universidad Rovira i Virgili" },
...
const CONTENT_EHU = {
  es: {
    ...
    propuestas: {
      ...
      lead: "Plazo ampliado hasta el 30 de septiembre de 2026. Se aceptan propuestas en español, euskara e inglés. Evaluación por pares.",
      timeline: [
        { date: "Hasta 30 Sep 2026 (ampliado)", label: "Cierre de envío de propuestas", status: "open" },
    ...
    presentacionDia: {
      title: "Programa",
      lead: "Tres días de ponencias plenarias, mesas redondas y sesiones paralelas en doble sede.",
      agendaLabels: {
        bilbao: "Hora Bilbao (CET)",
        manta: "Hora Manta (ECT)",
        session: "Sesión",
        bio: "Ver biografía",
        bioClose: "Cerrar",
        conjunta: "Conjunta",
        hybrid: "Híbrido · Bilbao & Manta",
        soloManta: "Solo Manta",
        soloBilbao: "Solo Bilbao",
        day: "Día",
      },
    },
    publicacion: {
    ...
    rollup: {
      kicker: "Congreso internacional",
      dateBig: "28–30",
      dateMonth: "Octubre 2026",
      scan: "Escanea para más información",
      web: "www.inedus.net",
      head_lines: "Líneas temáticas",
      head_program: "Programa",
      monthShort: "OCT",
      plenary: "Plenarias",
      d28: "Apertura institucional conjunta EHU–ULEAM y mesa redonda sobre los retos de la innovación educativa en el currículo universitario.",
      d29: "Sesiones locales de comunicaciones y simposio en Bilbao. Mesa redonda sobre educación, inclusión y sostenibilidad.",
      d30: "Sesiones locales de comunicaciones. Mesa redonda de cierre: la investigación conectada con los ODS y el entorno.",
      v1short: "Universidad del País Vasco · EHU",
      ui: {
        pageTitle: "Roll up INEDUS 2026",
        pageLead: "Diseño para imprenta con las medidas más habituales. Elige idioma y tamaño, y descarga el archivo.",
        language: "Idioma",
        size: "Medida",
        ...
        height: "Alto (cm)",
        download: "Descargar",
        pdf: "PDF (vectorial, para imprenta)",
        svg: "SVG (editable)",
        png: "PNG (vista previa)",
        back: "← Volver a la web",
        loading: "Preparando el diseño…",
        exporting: "Generando archivo…",
        errorLoad: "No se pudieron cargar las fuentes o los logos. Sirve la carpeta por HTTP y recarga.",
        errorExport: "No se pudo generar el archivo.",
        note: "Los logos son imágenes de mapa de bits: para tamaños grandes conviene sustituirlos por versiones vectoriales.",
        a4: "A-series",
        rollups: "Roll up",
  ...
  eu: {
    ...
    propuestas: {
      ...
      lead: "Lanak aurkezteko epea irailaren 30era arte luzatu da. Proposamenak euskaraz, gaztelaniaz eta ingelesez onartzen dira. Pareka ebaluatuko dira.",
      timeline: [
        { date: "Irailaren 30a arte (luzatua)", label: "Proposamenak bidaltzeko epea", status: "open" },
    ...
    presentacionDia: {
      title: "Programa",
      lead: "Hiru eguneko hitzaldi plenarioak, mahai-inguruak eta saio paraleloak bi egoitzatan.",
      agendaLabels: {
        bilbao: "Bilboko Ordua (CET)",
        manta: "Mantako Ordua (ECT)",
        session: "Saioa",
        bio: "Biografia ikusi",
        bioClose: "Itxi",
        conjunta: "Bateratua",
        hybrid: "Hibridoa · Bilbao & Manta",
        soloManta: "Manta soilik",
        soloBilbao: "Bilbao soilik",
        day: "Eguna",
      },
    },
    publicacion: {
    ...
    rollup: {
      kicker: "Nazioarteko kongresua",
      dateBig: "28–30",
      dateMonth: "Urria 2026",
      scan: "Eskaneatu informazio gehiagorako",
      web: "www.inedus.net",
      head_lines: "Ildo tematikoak",
      head_program: "Programa",
      monthShort: "URR",
      plenary: "Hitzaldi plenarioak",
      d28: "EHU–ULEAM irekiera instituzional bateratua eta mahai-ingurua unibertsitate-curriculumeko hezkuntza-berrikuntzaren erronkei buruz.",
      d29: "Komunikazio-saio lokalak eta sinposioa Bilbon. Mahai-ingurua hezkuntzari, inklusioari eta jasangarritasunari buruz.",
      d30: "Komunikazio-saio lokalak. Amaierako mahai-ingurua: ikerketa, GJHekin eta ingurunearekin lotuta.",
      v1short: "Euskal Herriko Unibertsitatea · EHU",
      ui: {
        pageTitle: "INEDUS 2026 roll up-a",
        pageLead: "Inprimategirako diseinua neurri ohikoenetan. Aukeratu hizkuntza eta tamaina, eta deskargatu fitxategia.",
        language: "Hizkuntza",
        size: "Neurria",
        ...
        height: "Altuera (cm)",
        download: "Deskargatu",
        pdf: "PDF (bektoriala, inprimategirako)",
        svg: "SVG (editagarria)",
        png: "PNG (aurrebista)",
        back: "← Webgunera itzuli",
        loading: "Diseinua prestatzen…",
        exporting: "Fitxategia sortzen…",
        errorLoad: "Ezin izan dira letra-tipoak edo logoak kargatu. Zerbitzatu karpeta HTTP bidez eta birkargatu.",
        errorExport: "Ezin izan da fitxategia sortu.",
        note: "Logoak bit-mapa irudiak dira: tamaina handietarako bertsio bektorialekin ordezkatzea komeni da.",
        a4: "A serieak",
        rollups: "Roll up",
  ...
  en: {
    ...
    propuestas: {
      ...
      lead: "Deadline extended to 30 September 2026. Proposals accepted in Spanish, Basque (Euskara) and English. Peer review.",
      timeline: [
        { date: "Until 30 Sep 2026 (extended)", label: "Proposal submission deadline", status: "open" },
    ...
    presentacionDia: {
      title: "Programme",
      lead: "Three days of plenary lectures, roundtables and parallel sessions at dual venues.",
      agendaLabels: {
        bilbao: "Bilbao Time (CET)",
        manta: "Manta Time (ECT)",
        session: "Session",
        bio: "View bio",
        bioClose: "Close",
        conjunta: "Joint",
        hybrid: "Hybrid · Bilbao & Manta",
        soloManta: "Manta only",
        soloBilbao: "Bilbao only",
        day: "Day",
      },
    },
    publicacion: {
    ...
    rollup: {
      kicker: "International congress",
      dateBig: "28–30",
      dateMonth: "October 2026",
      scan: "Scan for more information",
      web: "www.inedus.net",
      head_lines: "Thematic strands",
      head_program: "Programme",
      monthShort: "OCT",
      plenary: "Plenaries",
      d28: "Joint EHU–ULEAM institutional opening and round table on the challenges of educational innovation in the university curriculum.",
      d29: "Local paper sessions and symposium in Bilbao. Round table on education, inclusion and sustainability.",
      d30: "Local paper sessions. Closing round table: research connected with the SDGs and the surrounding context.",
      v1short: "University of the Basque Country · UPV/EHU",
      ui: {
        pageTitle: "INEDUS 2026 roll-up banner",
        pageLead: "Print-ready design in the most common sizes. Choose a language and a size, then download the file.",
        language: "Language",
        size: "Size",
        custom: "Custom",
        width: "Width (cm)",
        ...
        loading: "Preparing the design…",
        exporting: "Building file…",
        errorLoad: "Fonts or logos could not be loaded. Serve the folder over HTTP and reload.",
        errorExport: "The file could not be generated.",
        note: "Logos are bitmap images: for large sizes they should be replaced with vector versions.",
        a4: "A series",
        rollups: "Roll up",
