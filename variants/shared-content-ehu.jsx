...
const CONTENT_EHU = {
  es: {
    ...
    matricula: {
      title: "Matrícula",
      lead: "Solo para autores con trabajo aceptado. Plazo: antes del 15 de octubre de 2026.",
  ...
  eu: {
    ...
    matricula: {
      title: "Matrikula",
      lead: "Lan onartua duten egileentzat soilik. Epea: 2026ko urriaren 15a baino lehen.",
  ...
  en: {
    ...
    matricula: {
      title: "Registration",
      lead: "For accepted authors only. Deadline: before 15 October 2026.",
