...
const CONTENT_EHU = {
  es: {
    ...
    matricula: {
      ...
      lead: "Solo para autores con trabajo aceptado. Matrícula antes del 15 de octubre; envío del trabajo completo (opcional) hasta el 15 de noviembre.",
  ...
  eu: {
    ...
    heroTitleParts: ["Hezkuntza Berrikuntza,", "inklusio", "eta Jasangarritasuna Goi Mailako Hezkuntzan"],
    ...
    matricula: {
      ...
      lead: "Lan onartua duten egileentzat soilik. Matrikula urriaren 15a baino lehen; lan osoa (aukerakoa) azaroaren 15a arte.",
  ...
  en: {
    ...
    matricula: {
      ...
      lead: "For accepted authors only. Registration before 15 October; full paper submission (optional) before 15 November.",
